...
class ICM20948:
    ...
    def read(self, reg):
        ...
        return int.from_bytes(self._bus.readfrom_mem(self._addr, reg, 1), 'big')
    ...
    def read_bytes(self, reg, length=1):
        ...
        return list(self._bus.readfrom_mem(self._addr, reg, length))
    ...
    def __init__(self, i2c_addr=I2C_ADDR, i2c_bus=None):
        ...
        if i2c_bus is None:
            ...
            if not devices:
                ...
                print("Devices found at addresses:", [hex(addr) for addr in devices])
            print(i2c)
            self._bus = i2c
        else:
            self._bus = i2c_bus
